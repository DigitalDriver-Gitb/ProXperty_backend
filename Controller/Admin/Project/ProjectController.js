// import ProjectModel from "../../../models/Admin/Project/ProjectModel.js";
// import UserModel from "../../../models/Admin/Project/Enquiry.js";
...
//   sendEmail
// } from "../../../utilities/s3HelperUtility.js";
// import ConvertJSONtoExcel from "../../../utilities/ConvertJSONtoExcel.js";
...
//     try {
//       // Safely access request body with default empty object
//       const body = req.body || {};
...
//       console.log(data,"project data to be saved ")
...
// export const createProject = ProjectController.projectInsert;
// export const getProjects = ProjectController.projectviewAll;
// export const getProjectById = ProjectController.projectView;
// export const updateProject = ProjectController.projectUpdate;
// export const deleteProject = ProjectController.projectDelete;
...
//     const newProject = new ProjectModel({ name, description, imageUrl });
...
// helper to normalize string/array into array
const toArray = (val) => {
  if (!val) return [];
...
export const updateProject = async (req, res) => {
  try {
    ...
    const updated = await Project.findByIdAndUpdate(
      ...
      {
        ...data,
        projectRedefine_Connectivity: data.projectRedefine_Connectivity?.split(",") || [],
        projectRedefine_Education: data.projectRedefine_Education?.split(",") || [],
        projectRedefine_Business: data.projectRedefine_Business?.split(",") || [],
        projectRedefine_Entertainment: data.projectRedefine_Entertainment?.split(",") || [],
